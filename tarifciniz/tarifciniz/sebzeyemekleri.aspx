<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="sebzeyemekleri.aspx.cs" Inherits="tarifciniz.sebzeyemekleri" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="tariflerWrap">
                    ...
                    <asp:DataPager ID="DataPager1" PagedControlID="tarifList" PageSize="5" QueryStringField="sayfa"
            runat="server">
            <Fields>
